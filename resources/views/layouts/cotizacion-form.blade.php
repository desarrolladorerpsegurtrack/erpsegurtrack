...
@section('content')
    ...
    <style>
        ...
        .tom-select.tom-select--compact.ts-wrapper .ts-control {
            ...
            padding: 0.23rem 0.75rem 0.1rem 0.75rem !important;
                            ...
                            (function (){
                                            ...
                                            tomSelectInstance = new TS(selectProd, {
                                                ...
                                                render: {
                                                    option: function(data, escape) {
                                                        ...
                                                        return `<div class="px-2 py-1 ${disabledClass}">${escape(data.text)}</div>`;
                                                    }
                                                },
                                ...
                                function renderTempTable() {
                                    ...
                                    tempItems.forEach((item, index) => {
                                        ...
                                        tr.innerHTML = `
                                            ...
                                            <td class="px-3 py-2 border-b text-right text-xs">${item.price}</td>
                                ...
                                function addRowToGroup(tipo, itemData) {
                                    ...
                                    tr.innerHTML = `
                                        <td class="px-4 py-2">
                                            <div class="w-full">
                                                <input type="text" readonly class="form-control row-product-label w-full truncate overflow-hidden text-slate-800 bg-slate-50 border border-slate-200 px-2 py-2" value="${itemLabel}" title="${itemLabel}">
                                        ...
                                        <td class="px-2 py-2 text-right">
                                            <input type="number" min="0" step="0.01" class="form-control row-price text-right h-9 px-1" value="${itemData.price || 0}" ${window.formReadOnly ? 'disabled' : ''}>
                                        </td>
                                        <td class="px-2 py-2 text-center">
                                        ...
                                        <td class="px-4 py-2 text-right">
                                            <input type="text" readonly class="form-control row-subtotal text-right h-9 bg-slate-100 border-none font-medium px-2" value="${itemData.subtotal || 0}">
                                        </td>
