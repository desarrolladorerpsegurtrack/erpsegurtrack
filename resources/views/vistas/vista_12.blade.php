...
@section('title', $title ?? 'Vista 6')
@section('header', $title ?? 'Vista 6')
...
@section('content')
    <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12">
            <div class="box p-5">
                <h2 class="text-lg font-medium mr-auto">{{ $title ?? 'Vista 6' }}</h2>
                <p class="mt-3">Contenido de la Vista 6 Area Soporte</p>
