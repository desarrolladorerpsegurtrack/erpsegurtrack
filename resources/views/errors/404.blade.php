...
@section('content')
    <div class="min-h-screen relative flex items-center justify-center bg-slate-50 px-4 overflow-hidden">
        ...
        <div class="pointer-events-none absolute -top-24 -left-24 h-72 w-72 rounded-full bg-red-100 blur-3xl opacity-70"></div>
        <div class="pointer-events-none absolute -bottom-24 -right-24 h-72 w-72 rounded-full bg-slate-200 blur-3xl opacity-70"></div>
